...
<div class="jumbotron">
  <h1>Boda-Border</h1>
  <p>Treasure Your Meetings<p>
<br>
<form role="form" action="search.php" method="post">
  <div class="form-group">
    <input type="text" class="form-control" placeholder="Search By Area" name="searchArea">
  </div>
...
<div class="row">
  <div class="col-sm-12 col-md-6">
	...
	<p>If you use boda-boda and you liked it, you can register your favorite drivers. If you are a driver, you can register yourself. People use this service to find good drivers.</p>
      </div>
    </div>
  </div>
  <div class="col-sm-12 col-md-6">
    <div class="thumbnail">
      <div class="caption">
        <h3>STEP 2</h3>
	<h4>Search</h4>
	<p>Let you search drivers you want to ride from navigation var on the top. You can search drivers who are near your place or who are very safer than others by drivers' areas.</p>
  </form>
